...
class AnimationManager:
    ...
    def add_animation_sequence(self, name_in_database, path_to_folder, number_of_frames, file_type, scale:tuple):
        """
        ...
        for i in range(number_of_frames):
            ...
            animation_image = pygame.transform.scale(pygame.image.load(animation_path).convert_alpha(), scale)
